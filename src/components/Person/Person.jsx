                ...
                <div className="profileContent">
                    ...
                    <div className="info">
                        ...
                        <div className="icons">
                            ...
                            <BiSolidLike  style={{marginLeft: '40px', marginTop:'-4px'}} min-size="1.8vw" color="#FFBE22" /><label>12</label>
            ...
            <section className="section2">
                ...
                <div className="postList">
                    <div className="postHead">
                        ...
                        <BiSolidLike style={{position: 'absolute', left: '90%', marginTop:'-5px'}} min-size="1.5vw" color="#FFBE22" />
                    </div>
